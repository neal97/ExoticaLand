 ...
 */
final class Version20230222085431 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles ADD categorie_id INT DEFAULT NULL, DROP categorie');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles ADD categorie VARCHAR(255) NOT NULL, DROP categorie_id');
    }
}
